  ...
  return (
    <>
      ...
      <main className="coe-detail">
        <section id="hero" aria-label="Cloud & Infrastructure - Applied AI hero video">
        ...
        <section id="hero-copy" aria-label="Cloud & Infrastructure - Applied AI intro">
          <div className="container text-center hero-content hero-copy">
            ...
            <p className="hero-body anim slide-rtl observe-me" style={{ ['--delay' as any]: '0.32s' }}>
              ...
              We design AI-enhanced cloud foundations that perform under load, stay secure, and scale with your business goals.
            </p>
