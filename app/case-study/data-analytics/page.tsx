...
const steps = [
  ...
  { num: '03', title: 'Step 3: Creating One Version of the Truth', body: 'We built a Unified Data Model and implemented Master Data Management to deal with the inconsistent data, plaguing the bank. This standardized the trade data, counterparty information, and reference data.' },
  { num: '04', title: 'Step 4: Powering Advanced Analytics at Speed', body: 'We deployed a high-performance layer using Databricks and Snowflake for heavy-duty analytics. This worked best for portfolio risk calculations, scenario modeling, and stress testing at speeds that simply were not possible before.' },
  { num: '05', title: 'Step 5: Putting Insights in the Hands of Business Users', body: 'We rolled out self-service business intelligence through Power BI and Tableau. This gave traders, risk analysts, and compliance officers the ability to explore data and generate reports on their own terms.' },
  { num: '06', title: 'Step 6: Building Governance Into the DNA', body: 'We deployed Apache Atlas and Collibra so that the bank can experience automated data lineage, governance controls, and audit trails. The bank now has full visibility into the origin of data, its transformation, and its intended use.' },
]
